          ...
          {selectedMonthlyBudget ? (
            <>
              ...
              {renderLine(
                ...
                otherValues.reserveAmount
              )}

              <Calendar
                className="w-screen border-2 border-gray-300 rounded-xl bg-transparent p-4"
                headerStyle={{
                  borderBottomWidth: 2,
              ...
              {renderLine(
                ...
                otherValues.monthlySpendingLimit
              )}
              {renderLine(
                "Limite de gastos diários",
                otherValues.dailySpendingLimit
              )}
              {/* <View className="">
							<Button
