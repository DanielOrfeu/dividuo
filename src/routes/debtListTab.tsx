...
const TabButton = (props) => {
  return (
    ...
    >
      <View
        className={clsx(
          "flex flex-row flex-1 justify-center items-center mx-12 my-2",
          {
      ...
      >
        <MaterialCommunityIcons
          name={`cash-${props.name == "A receber" ? "plus" : "minus"}`}
          size={24}
          color={COLOR.white}
        />
    ...
    >
      <Screen
        ...
        options={{
          ...
          tabBarButton: (props) => <TabButton {...props} name={"A receber"} />,
        }}
      />
      <Screen
        name="DebtListToPay"
        ...
        options={{
          ...
          tabBarButton: (props) => <TabButton {...props} name={"A pagar"} />,
        }}
      />
    </Navigator>
  );
